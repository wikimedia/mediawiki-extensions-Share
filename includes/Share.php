...
class ShareHooks {
	...
	public static function onSkinBuildSidebar( Skin $skin, &$bar ) {
		...
		if ($wgShareFacebook == true && $wgShareUseBasicButtons != true && $wgShareUsePlainLinks != true) {
			$bar['share-header'][] = [
		...
		if ($wgShareTwitter == true && $wgShareUseBasicButtons != true && $wgShareUsePlainLinks != true) {
			$bar['share-header'][] = [
		...
		if ($wgShareLinkedIn == true && $wgShareUseBasicButtons != true && $wgShareUsePlainLinks != true) {
			$bar['share-header'][] = [
		...
		if ($wgShareTumblr == true && $wgShareUseBasicButtons != true && $wgShareUsePlainLinks != true) {
			$bar['share-header'][] = [
		...
		if ($wgShareEmail == true && $wgShareUseBasicButtons == true && $wgShareUsePlainLinks != true) {
			$bar['share-header'][] = [
		...
		if ($wgShareReddit == true && $wgShareUseBasicButtons == true && $wgShareUsePlainLinks != true) {
			$bar['share-header'][] = [
	...
	// User preference to disable sidebar
